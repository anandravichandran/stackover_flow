...
const Widget = () => {
  return (
    <div className='widget'>
        ...
        <div clasName='right-sidebar-div-1'>
        ...
        <div clasName='right-sidebar-div-1'>
            ...
            <div className='right-sidebar-div-2'>
               ...
               <p>Outdated Answers: accepted answer is now unpinned on Stack Overflow<br/>-V2Blast #959 -SpencerG</p>  
            </div>
        ...
        <div clasName='right-sidebar-div-1'>
            <div className='right-sidebar-div-2'>
               <p>38</p>
               <p>Why was this spam flag declined,yet the question marked as a pen</p>  
            </div>
            <div className='right-sidebar-div-2'>
              <p>20</p>
